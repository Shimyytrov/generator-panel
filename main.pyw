...
while  True:
    ...
    if 240 <= total_time <= 400:    # logo 2
        if total_time == 240:   title_2.play()
    ...
    if total_time == 450:   swap.play()
    if total_time >= 450 and not langseleted1: # lang select title
        ...
        screen.blit(langsel, langsel.get_rect())
        # underline
